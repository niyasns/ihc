...
<div class="container">
    <div class="row">
        <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
            <legend>Add Venue Details</legend>
            <?php
            $attributes = array("class" => "form-horizontal", "id" => "venueform", "name" => "venueform");
            echo form_open("venues/create", $attributes);?>
            <fieldset>
                ...
                <div class="form-group">
                    <div class="row colbox">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            <input id="venuename" name="venuename" placeholder="venuename" type="text" class="form-control"  value="<?php echo set_value('venuename'); ?>" />
